...
public class UserController {
    ...
    public String getWeChatCode(HttpServletRequest request, String code) throws IOException {
        log.info("【微信Code】code={}", code);
        String openId = WeChatUtil.getOpenId(code);
        try {
            UserVO userVO = userService.weChatLogin(request, openId);
            return "<script>location.href='https://www.xuanhuobang.com/#/my?token=" + userVO.getToken() + "'</script>";
        } catch (XShopException e) {
            return "<script>alert('" + e.getMessage() + "');location.href='https://www.xuanhuobang.com/#/my</script>";
        }
    }

    @GetMapping("/bindWeChat")
    public String bindWeChat(String code, String state) throws IOException {
        log.info("【绑定微信】code={}, state={}", code, state);
        try {
            userService.bindWeChat(code, state);
            return "<script>alert('绑定成功！');location.href='https://www.xuanhuobang.com/'</script>";
        } catch (XShopException e) {
            return "<script>alert('" + e.getMessage() + "');location.href='https://www.xuanhuobang.com/#/my'</script>";
        }
    }
