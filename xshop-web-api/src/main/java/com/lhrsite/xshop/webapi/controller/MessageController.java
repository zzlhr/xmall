...
public class MessageController {
    ...
    public ResultVO getMessageList(String token, Integer type, long page, long pageSize) throws XShopException {
    ...
    public ResultVO getNewOrderCount(String token) throws XShopException {
        ...
        result.put("count", messageService.getMessageNoReadCount(token, 1));
