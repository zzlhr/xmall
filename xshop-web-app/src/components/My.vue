    ...
    <div v-transfer-dom>
      <x-dialog v-model="showDialog" :v-show="showDialog" class="dialog-demo" hide-on-blur>
        <div style="padding:15px;">
          ...
          <group>
            <x-input title='密 码' type="password" v-if="!smsCodeLogin" v-model="loginForm.password"></x-input>
          ...
          <div class="op_line">
            ...
            <x-button class="op_login_l" mini plain type="primary" v-if="smsCodeLogin" @click.native="sendLoginCode">{{
