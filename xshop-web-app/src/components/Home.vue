    ...
    <div class="scrollerWrap">
      <main>
        ...
        <card :header="cardTitle">
          ...
          <grid :show-lr-borders="false">
            <grid-item label="活动商品" @click.native="goSale(1)">
              <img slot="icon" src="../assets/logo.png" alt="活动商品">
            </grid-item>
            <grid-item label="精选商品" @click.native="goSale(2)">
              <img slot="icon" src="../assets/logo.png" alt="精选商品">
            </grid-item>
            <grid-item label="包邮商品" @click.native="goSale(3)">
              <img slot="icon" src="../assets/logo.png" alt="包邮商品">
            </grid-item>
            <grid-item label="新店必备" @click.native="goSale(4)">
              <img slot="icon" src="../assets/logo.png" alt="新店必备">
            </grid-item>
          </grid>
        </card>
        ...
        <div style="margin-bottom: 60px">
          <group>
            <cell v-for="(item, index) in priceRange" :key="index" :title="item.clName" :link="'class1c/'+item.clId"
